...
__install_saltstack_rhel_repository() {
    ...
    base_url="${HTTP_VAL}://archive.${_REPO_URL}/${__PY_VERSION_REPO}/redhat/${DISTRO_MAJOR_VERSION}/\$basearch/${repo_rev}/"
...
_eof
        ...
        fetch_url="${HTTP_VAL}://archive.${_REPO_URL}/${__PY_VERSION_REPO}/redhat/${DISTRO_MAJOR_VERSION}/${CPU_ARCH_L}/${repo_rev}/"
