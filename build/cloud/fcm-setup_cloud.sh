...
wget https://raw.githubusercontent.com/alces-software/flight-monitor/master/build/cloud/fcm-webserver.sh -O /tmp/fcm-webserver.sh --no-check-certificate
wget https://raw.githubusercontent.com/alces-software/flight-monitor/master/build/cloud/fcm-fcops-user.sh -O /tmp/fcm-fcops-user.sh --no-check-certificate
