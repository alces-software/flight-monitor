...
wget https://raw.githubusercontent.com/alces-software/flight-monitor/barkla-fc-gateway/resources/zabbix_proxy.conf -O /etc/zabbix/zabbix_proxy.conf
wget https://raw.githubusercontent.com/alces-software/flight-monitor/barkla-fc-gateway/resources/zabbix_agentd.monitor.conf -O /etc/zabbix/zabbix_agentd.conf
wget https://raw.githubusercontent.com/alces-software/flight-monitor/barkla-fc-gateway/build/vpn-client.sh -O /tmp/fcm-vpnclient.sh 
wget https://raw.githubusercontent.com/alces-software/flight-monitor/barkla-fc-gateway/build/fcm-webserver.sh -O /tmp/fcm-webserver.sh 
