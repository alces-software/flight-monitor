...
NAME="fcm-$(date +%Y%m%d%H%M%S)"

virt-install \
--name $NAME \
--ram 4096 \
--disk path=/opt/vm/$NAME.qcow2,size=40 \
--vcpus 2 \
--os-type linux \
...
--location 'http://10.150.0.10/repo/centos/7.7.1908/base' \
--initrd-inject ./fcm-libvirt.ks \
--extra-args 'console=tty0 console=ttyS0,115200n8 ip=eth1:dhcp bootdev=eth1 ks=file:/fcm-libvirt.ks'
