...
FCOPS_PASSWORD=$(curl http://fcgateway/resources/maint_scripts/adopt_config |grep fcops_pass |awk '{print $2}')
PUB_SSH_KEY=$(curl http://fcgateway/resources/maint_scripts/adopt_config |grep ssh_key |awk '{print $2,$3,$4}')
