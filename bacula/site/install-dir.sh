...
wget https://raw.githubusercontent.com/alces-software/flight-monitor/master/bacula/site/resources/bacula-dir.conf -O /opt/bacula/etc/bacula-dir.conf --no-check-certificate -q
wget https://raw.githubusercontent.com/alces-software/flight-monitor/master/bacula/site/resources/bacula-fd.conf -O /opt/bacula/etc/bacula-fd.conf --no-check-certificate -q
wget https://raw.githubusercontent.com/alces-software/flight-monitor/master/bacula/site/resources/bacula-sd.conf -O /opt/bacula/etc/bacula-sd.conf --no-check-certificate -q
wget https://raw.githubusercontent.com/alces-software/flight-monitor/master/bacula/site/resources/bconsole.conf -O /opt/bacula/etc/bconsole.conf --no-check-certificate -q
...
wget https://raw.githubusercontent.com/alces-software/flight-monitor/master/bacula/site/resources/notif.conf -O /opt/bacula/slack/notif.conf
wget https://raw.githubusercontent.com/alces-software/flight-monitor/master/bacula/site/resources/slack.sh -O /opt/bacula/slack/slack.sh
